...
#define C2_R33		(gteRegs.CP2C.p[ 4 ].sd)
...
#define C2_L33		(gteRegs.CP2C.p[ 12 ].sd)
...
#define C2_LB3		(gteRegs.CP2C.p[ 20 ].sd)
...
#define C2_H		(gteRegs.CP2C.p[ 26 ].sd)
#define C2_DQA		(gteRegs.CP2C.p[ 27 ].sd)
#define C2_DQB		(gteRegs.CP2C.p[ 28 ].sd)
#define C2_ZSF3		(gteRegs.CP2C.p[ 29 ].sd)
#define C2_ZSF4		(gteRegs.CP2C.p[ 30 ].sd)
