...
/* PsyX_SPUSoftware_StopLoopingVoices via the backend rename; routed from
 * Pc_SpuStopLoopingVoices in PsyX_SPUDispatch.cpp. */
void PsyX_SPUAL_StopLoopingVoices(void)
{
    SDL_LockMutex(g_spuMutex);
