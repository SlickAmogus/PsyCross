...
extern "C" { float g_PsxFeedbackDamp = 0.8f; } /* loading-trail ghost strength, matched by eye to a real PS1 */
...
static const char* s_fbPackShaderSrc =
	 ...
	 *
	 * Persistence is then set by the gain, u_feedbackDamp (FBDAMP, 0.8): each
